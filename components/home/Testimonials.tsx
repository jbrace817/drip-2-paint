  ...
  return (
    <section className="py-32 bg-white">
      <div className="container px-4 mx-auto flex flex-col lg:col-span-2 lg:mt-20 lg:grid lg:grid-cols-[1fr_2fr]  md:gap-6 lg:gap-8 ">
        <div className="mb-8 flex items-end justify-between lg:flex-col lg:items-start lg:justify-between  md:mb-14 lg:mb-16">
          <div>
            <p className="text-xl/7 font-semibold text-coolGray-dark5">
              Don't Just Take Our Word For It
            </p>
            <h2 className="mb-5 text-pretty text-3xl font-bold lg:text-4xl bg-gradient-to-r from-primary-light4 to-primary-dark2 inline-block bg-clip-text text-transparent">
              Hear It Straight From Our Clients
            </h2>
          </div>
          <div className="hidden shrink-0 gap-2 md:flex md:self-start">
            <Button
              size="icon"
              variant="outline"
              onClick={() => {
